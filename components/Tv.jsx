...
import tv from '../assets/img/raghs.png'
    ...
    return (
        <section className=' w-full h-[500px] flex flex-wrap'>
            <article className=' flex flex-wrap w-full md:w-[50%] h-full content-center justify-center'>
                <h2 className=' w-full h-[40px] flex items-center justify-center text-white text-[22px] font-melo ps-12 tracking-wider'>چطور با تلویزیون، فیلیمو تماشا کنم؟</h2>
                <p className=' w-[60%] h-[140px] flex flex-wrap items-center justify-center text-[rgba(255,255,255,.75)] text-[15px] font-melo ps-12 tracking-wider'>ما برای راحتی شما و تماشای فیلیمو روی تلویزیون‌های مختلف 6 روش را فراهم کردیم. هرکدام از این 6 روش یک ویدیو آموزشی دارند که می‌توانید از لینک زیر، آن‌ها را تماشا کنید و روشی که با تلویزیون شما سازگار است را انتخاب کنید.</p>
                <div className=' w-full h-[40px] flex items-center justify-center text-white text-[17px] font-melo ps-12 tracking-wider'>
                ...
                <p className=' w-full h-[40px] flex items-start justify-center text-[#bbb5b5] text-[10px] font-melo ps-16 tracking-wider'>Amazon Fire TV - LG TVs - Chrome Cast - Apple TV - Android TV devices - Samsung</p>
                <div className=' w-full h-[40px] flex items-center justify-center text-white text-[17px] font-melo ps-12 tracking-wider'>
                ...
                <p className=' w-full h-[40px] flex items-start justify-center text-[#bbb5b5] text-[10px] font-melo ps-16 tracking-wider'>NVIDIA - amazon - xiaomi - minix - skystream - turewell - ematic - humax - matricom</p>
                ...
                <div className=' w-full flex ps-16 justify-center items-center'>
                    <button className='h-[40px] w-[240px] duration-500 hover:bg-[#9a9797] mx3 rounded-[6px] bg-[#606060] flex justify-center items-center '>
                        ...
                        <div className='text-[13px] text-white mx-2 font-melo tracking-widest'>ویدیو های اموزشی تماشا با تلویزیون</div>
            ...
            <figure className=' flex-wrap w-full md:w-[50%] h-full flex items-center justify-center md:justify-start'>
                <img src={tv} alt="" className='md:w-[90%] md:h-[90%] h-[80%] w-[80%]' />
            </figure>
        </section>
    )
}
