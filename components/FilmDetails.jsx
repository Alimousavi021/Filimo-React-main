...
const FilmDetails = ({ show, img, y, name, ename, kargardan, like, imdb, zhanr, kholase, time }) => {
    return (
        <section className={`${show !== y ? 'hidden' : 'flex'}  w-full h-full bg-inherit flex`}>
            <div className='w-full h-[85%] relative flex justify-center items-center'>
                ...
                <div className='absolute w-full h-full flex flex-wrap justify-center content-center  bg-[#00000098]'>
                    <h2 className='w-full h-[50px]  flex items-center justify-start text-white font-melo text-[25px] tracking-wide ps-16'>{name}</h2>
                    ...
                    <div className=' w-full flex ps-16 justify-start items-center'>
                        <button className='h-[45px] w-[275px] duration-500 hover:bg-[#367b55] mx3 rounded-[3px] bg-[#1cb561] flex justify-center items-center '>
                            ...
                            <div className='text-[16px] text-white mx-2 font-melo tracking-wider'> خرید اشتراک و تماشا</div>

                        </button>
                    </div>

                    <p className='w-full h-[50px]  flex items-center justify-start text-[#bbb5b5] font-melo text-[13px] tracking-wider ps-16'>{time}</p>
                </div>
            </div>
        </section>
    )
