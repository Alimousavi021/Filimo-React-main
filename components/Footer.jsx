    ...
    return (
        <section className='w-full h-[500px]  green flex justify-center items-center'>
            <div className=' w-[85%] h-[85%] flex flex-wrap items-center content-center'>
                <h1 className='w-full flex justify-center items-center text-white font-melo text-[85px] '>فیلیمو</h1>
                ...
                <div className='w-full flex flex-wrap justify-center'>
                    <div className='h-[70px] w-full md:w-[30%] flex justify-center items-center '>
                        ...
                        <h3 className='mx-2  tracking-wide font-melo text-[rgba(255,255,255,.75)] text-[16px] md:text-[18px]'>
                    ...
                    <div className='h-[70px] w-full md:w-[30%] flex justify-center items-center '>
                        ...
                        <h3 className='mx-2  tracking-wide font-melo text-[rgba(255,255,255,.75)] text-[16px] md:text-[18px]'>هزاران انیمیشن و کارتون برای کودکان</h3>
                    </div>
                    <div className='h-[70px] w-full md:w-[30%] flex justify-center items-center '>
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#1cb561" class="bi bi-check-circle-fill" viewBox="0 0 16 16">
                            <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0m-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                        </svg>
                        <h3 className='mx-2  tracking-wide font-melo text-[rgba(255,255,255,.75)] text-[16px] md:text-[18px]'>پشتیبانی 24 ساعته برای راهنمایی شما</h3>
                    </div>
